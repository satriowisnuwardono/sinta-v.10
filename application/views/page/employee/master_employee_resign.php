  ...
  <div class="container-fluid">
    <div class="card card-warning card-outline">
      <div class="card-header">
        <h3 class="card-title"><i class="fas fa-clipboard-list"></i> Employee Resign Data Table</h3>
      </div>
      <div class="card-body">
        <table id="example1" class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="center"><?= $emp->resign_date?></td>
              <td align="center">
                <a href="<?= base_url('employee/employee_resign_details/'.$emp->employee_code); ?>" class="btn btn-warning btn-sm" style="width: 100%;"><i class="fas fa-user-edit"></i></a>
              </td>
            </tr>
          <?php endforeach; ?>
          </tbody>
