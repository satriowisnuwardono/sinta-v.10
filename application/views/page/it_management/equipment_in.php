<!-- Content Header (Page header) -->
        ...
        <div class="flash-data-equipment" data-flashdata="<?= $this->session->flashdata('flash'); ?>"></div>
          <div class="card card-warning card-outline">
            <div class="card-header">
              <h3 class="card-title">Incoming Equipment List</h3>
            </div>
            <div class="card-header">
              <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#add_incoming_equipment"><i class="fas fa-plus-square"></i> Add Incoming Equipment</a>
            </div>
            <div class="card-body">
    ...
    <!-- MOdal -->
    <!-- Modal Add Equipment -->
    <div class="modal fade" id="add_incoming_equipment" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
       <div class="modal-dialog" role="document">
         <div class="modal-content">
           <div class="modal-header">
             <h5 class="modal-title" id="staticBackdropLabel">Add Equipment Incoming</h5>
             <button type="button" class="close" data-dismiss="modal" aria-label="Close">
               <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <?php echo form_open('it_management/add_equipment_incoming'); ?>
          <div class="modal-body">
            ...
            <div class="form-group row">
              <label for="request_date" class="col-sm-4 control-label">Request Date</label>
              <div class="col-sm-8">
                <div class="input-group">
                    <div class="input-group-prepend">
                      ...
                      <input type="date" name="request_date" id="request_date" value="" class="form-control form-control-sm">
                  </div>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <div class="input-group">
                    <div class="input-group-prepend">
                      ...
                      <input type="date" name="date_in" id="date_in" value="" class="form-control form-control-sm">
                  </div>
              </div>
            </div>
            <div class="form-group row">
