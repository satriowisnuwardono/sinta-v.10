<!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Details Job Order IT Complete</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="card card-info card-outline">
          <div class="card-header">
            <h3 class="card-title">Details Job Order Complete</h3>
          </div>
          <div class="card-body">
          ...
          <div class="card-footer">
            <a href="<?php echo base_url('it_management/jo_complete'); ?>" class="badge badge-light badge-pill"><i class="fas fa-arrow-circle-left"> Back</i></a>
          </div>
        </div>
      </div>
    </section>
